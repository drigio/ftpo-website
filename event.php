...
<body>
    ...
    <div class="container-fluid remove-all-margin-padding">
        ...
        <div class="container">
            ...
            <div class="event">
                <div class="row">
                    <div class="event-title" style="margin: 0 auto;">
                        <h1 class="display-4"> <?php echo $row["title"]; ?> </h1>
                    </div>
                    <div class="event-imgs row">
                        <div class="col-md-4">
                            <?php echo '<img class="img-thumbnail" src="data:image/jpeg;base64,'.base64_encode( $row["img1"] ).'"/>'; ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo '<img class="img-thumbnail" src="data:image/jpeg;base64,'.base64_encode( $row["img2"] ).'"/>'; ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo '<img class="img-thumbnail" src="data:image/jpeg;base64,'.base64_encode( $row["img3"] ).'"/>'; ?>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <!-- <div class="event">
                <div class="row">
                    ...
                    <div class="event-imgs row">
                        <div class="col-md-4">
                            <img src="./assets/img/Events/event1.jpg" alt="" class="img-thumbnail">
                        </div>
                        <div class="col-md-4">
                            <img src="./assets/img/Events/event1.jpg" alt="" class="img-thumbnail">
                        </div>
