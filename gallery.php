<?php 
    ...
    $result = $mysqli->query($sql_gallery);
    $count = 1;
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid remove-all-margin-padding">
        ...
        <div class="container">
            <div class="row">
                <div class="page-header" style="margin: 1em auto;">
                    <h2 class=""> Gallery </h2>
                </div>
            </div>
            <div class="image-gallery">
                <div class="row">
                    ...
                    <?php  while( $row = $result->fetch_assoc() ) { if($count % 5 == 0) { ?>
                </div>
                <div class="row">
                    <div class="col-md">
                        <?php echo '<img class="img-thumbnail mr-4 mt-4" src="data:image/jpeg;base64,'.base64_encode( $row["img"] ).'"/>'; ?>
                    </div>
                    ...
                    <div class="row text-center text-xs-center text-sm-left text-md-left">
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <ul class="list-unstyled quick-links" style="margin-left: 2em;">
                                ...
                                <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Committee</a>
                                </li>
                                <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Gallery</a>
                                </li>
                                <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Contact</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <h5>Contact</h5>
                            <ul class="inf">
                                <li><i class="fa fa-university" aria-hidden="true"></i> Zeal College Of Engineering And
                                    Research
                                </li>
                                ...
                                <li><i class="fa fa-envelope" aria-hidden="true"></i> <a
                                        href="mailto:tpo.dypatilcoe@gmail.com" class="w3ls-a" target="_blank">
                                        tpo.dypatilcoe@gmail.com</a></li>
                        </div>
